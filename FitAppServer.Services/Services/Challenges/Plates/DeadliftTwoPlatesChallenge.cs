...
public class DeadliftTwoPlatesChallenge : IChallenge
{
    private readonly FitAppContext _context;

    public DeadliftTwoPlatesChallenge(FitAppContext context)
    {
        _context = context;
    }
    ...
    public string GetId() => "deadliftTwoPlatesChallenge";
